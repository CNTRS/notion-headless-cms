...
Define the transformation logic that groups consecutive Notion list item blocks into list containers. TBD — initial requirements imported from `domain-core` change.
